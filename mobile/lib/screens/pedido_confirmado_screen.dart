...
class PedidoConfirmadoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Rolagem responsiva: centraliza quando há espaço e permite rolar em
      // telas menores, garantindo que o botão nunca seja cortado.
      body: SafeArea(
        child: LayoutBuilder(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _InfoRow(
                                    label: 'Modalidade',
                                    value: pedido.modalidade.label),
                                _InfoRow(
                                    label: 'Pagamento',
                                    value: pedido.formaPagamento.label),
                                const SizedBox(height: 8),
                                Row(
