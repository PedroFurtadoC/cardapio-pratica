...
produtos = [
    # --- MARMITAS (Item Composto) ---
    {
        ...
        "preco_centavos": 2000,
        "imagem_url": "https://placehold.co/600x400/FFF7ED/EA580C?text=Marmita+Pequena",
        "categoria": "MARMITAS",
        "ativo": True,
        "tipo": "COMPOSTO",
    ...
    },
    {
        ...
        "preco_centavos": 2600,
        "imagem_url": "https://placehold.co/600x400/FFF7ED/EA580C?text=Marmita+Media",
        "categoria": "MARMITAS",
        "ativo": True,
        "tipo": "COMPOSTO",
    ...
    },
    {
        ...
        "preco_centavos": 3200,
        "imagem_url": "https://placehold.co/600x400/FFF7ED/EA580C?text=Marmita+Grande",
        "categoria": "MARMITAS",
        "ativo": True,
        "tipo": "COMPOSTO",
    ...
    # --- SALGADOS E PRATOS ESPECIAIS ---
    {
        ...
        "preco_centavos": 950,
        "imagem_url": "https://placehold.co/600x400/FEF3C7/D97706?text=Coxinha",
        "categoria": "SALGADOS",
        "ativo": True,
        "tipo": "SIMPLES",
        "tags_dieteticas": ["SEM_GLUTEN", "SEM_LEITE"]
    },
    {
        ...
        "preco_centavos": 950,
        "imagem_url": "https://placehold.co/600x400/FEF3C7/D97706?text=Kibe+de+Forno",
        "categoria": "SALGADOS",
        "ativo": True,
        "tipo": "SIMPLES",
        "tags_dieteticas": ["SEM_GLUTEN", "SEM_LEITE"]
    },
    {
        ...
        "preco_centavos": 2400,
        "imagem_url": "https://placehold.co/600x400/FEF08A/A16207?text=Escondidinho",
    ...
    # Coca-Cola
    { "nome": "Coca-Cola Original (Lata 350ml)", "descricao": "Refrigerante.", "preco_centavos": 600, "imagem_url": "https://placehold.co/600x400/EF4444/ffffff?text=Coca-Cola+Lata", "categoria": "BEBIDAS", "ativo": True, "tipo": "SIMPLES", "tags_dieteticas": [] },
    { "nome": "Coca-Cola Sem Açúcar (Lata 350ml)", "descricao": "Zero Açúcar.", "preco_centavos": 600, "imagem_url": "https://placehold.co/600x400/18181B/ffffff?text=Coca-Cola+Zero", "categoria": "BEBIDAS", "ativo": True, "tipo": "SIMPLES", "tags_dieteticas": ["SEM_ACUCAR"] },
    { "nome": "Coca-Cola Original (600ml)", "descricao": "Garrafa média.", "preco_centavos": 850, "imagem_url": "https://placehold.co/600x400/EF4444/ffffff?text=Coca-Cola+600ml", "categoria": "BEBIDAS", "ativo": True, "tipo": "SIMPLES", "tags_dieteticas": [] },
    { "nome": "Coca-Cola Original (2 Litros)", "descricao": "Garrafa família.", "preco_centavos": 1400, "imagem_url": "https://placehold.co/600x400/EF4444/ffffff?text=Coca-Cola+2L", "categoria": "BEBIDAS", "ativo": True, "tipo": "SIMPLES", "tags_dieteticas": [] },
    
    # H2O
    { "nome": "H2O Limão (500ml)", "descricao": "Levemente gaseificada.", "preco_centavos": 700, "imagem_url": "https://placehold.co/600x400/ECFCCB/4D7C0F?text=H2O+Limao", "categoria": "BEBIDAS", "ativo": True, "tipo": "SIMPLES", "tags_dieteticas": ["SEM_ACUCAR"] },
    { "nome": "H2O Limoneto (500ml)", "descricao": "Sabor intenso de limão.", "preco_centavos": 700, "imagem_url": "https://placehold.co/600x400/ECFCCB/4D7C0F?text=H2O+Limoneto", "categoria": "BEBIDAS", "ativo": True, "tipo": "SIMPLES", "tags_dieteticas": ["SEM_ACUCAR"] },
    
    # Sucos e Água
    { "nome": "Suco de Laranja Natural (500ml)", "descricao": "Espremido na hora.", "preco_centavos": 1000, "imagem_url": "https://placehold.co/600x400/FEF08A/A16207?text=Suco+Laranja", "categoria": "BEBIDAS", "ativo": True, "tipo": "SIMPLES", "tags_dieteticas": ["VEGANO", "SEM_GLUTEN", "SEM_LEITE"] },
    { "nome": "Suco de Uva Integral (300ml)", "descricao": "Sem conservantes.", "preco_centavos": 900, "imagem_url": "https://placehold.co/600x400/E9D5FF/6B21A8?text=Suco+Uva", "categoria": "BEBIDAS", "ativo": True, "tipo": "SIMPLES", "tags_dieteticas": ["VEGANO", "SEM_GLUTEN", "SEM_LEITE"] },
    { "nome": "Água Mineral s/ Gás (500ml)", "descricao": "", "preco_centavos": 400, "imagem_url": "https://placehold.co/600x400/E0F2FE/0369A1?text=Agua+Mineral", "categoria": "BEBIDAS", "ativo": True, "tipo": "SIMPLES", "tags_dieteticas": [] },
    ...
    # --- SOBREMESAS / DOCES ---
    {
        ...
        "preco_centavos": 1200,
        "imagem_url": "https://placehold.co/600x400/FFE4E6/E11D48?text=Brownie",
    ...
    },
    {
        ...
        "preco_centavos": 1400,
        "imagem_url": "https://placehold.co/600x400/FFE4E6/E11D48?text=Bolo+de+Cenoura",
        "categoria": "SOBREMESAS",
        "ativo": True,
        "tipo": "SIMPLES",
    ...
    },
    {
        ...
        "preco_centavos": 1100,
        "imagem_url": "https://placehold.co/600x400/FEF08A/A16207?text=Mousse",
        "categoria": "SOBREMESAS",
        "ativo": True,
        "tipo": "SIMPLES",
        "tags_dieteticas": ["SEM_GLUTEN", "SEM_LEITE", "VEGANO"]
